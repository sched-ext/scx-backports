...
pub const layer_match_kind_MATCH_USED_GPU_TID: layer_match_kind = 15;
pub const layer_match_kind_MATCH_USED_GPU_PID: layer_match_kind = 16;
...
const _: () = {
    ...
    ["Offset of field: layer_match::used_gpu_tid"]
        [::std::mem::offset_of!(layer_match, used_gpu_tid) - 4169usize];
    ["Offset of field: layer_match::used_gpu_pid"]
        [::std::mem::offset_of!(layer_match, used_gpu_pid) - 4170usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
